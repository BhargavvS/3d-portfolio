    ...
    <SectionWrapper>
      <>
        ...
        <div className="w-full flex">
          ...
          >
            Following projects showcase my backend and full-stack experience
            through real-world systems — fault-tolerant queues, streaming APIs,
            ML services, and RAG assistants. Each project links to its code
            repository; live demos are in progress where noted.
          </motion.p>
        </div>
